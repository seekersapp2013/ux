...
export const ChromeIcon: React.FC<BoxProps> = props => (
  <Svg {...props}>
    ...
    <g mask="url(#mask0)">
      ...
      <path d="M2.27002 1V10.8182H5.85093L9.00002 5.36364H17V1H2.27002Z" fill="url(#paint0_linear)" />
      <path
      ...
      <path d="M1 17H8.61545L12.15 13.4654V10.8182H5.85091L1 2.49817V17Z" fill="url(#paint1_linear)" />
      <path
      ...
      <path d="M9.00002 5.36365L12.15 10.8182L8.61548 17H17V5.36365H9.00002Z" fill="url(#paint2_linear)" />
      <path d="M9.00002 5.36365L12.15 10.8182L8.61548 17H17V5.36365H9.00002Z" fill="#FFCD40" />
      <path d="M9.00002 5.36365L12.15 10.8182L8.61548 17H17V5.36365H9.00002Z" fill="url(#paint3_linear)" />
      <path d="M2.27002 1V10.8182H5.85093L9.00002 5.36364H17V1H2.27002Z" fill="#DB4437" />
      <path d="M2.27002 1V10.8182H5.85093L9.00002 5.36364H17V1H2.27002Z" fill="url(#paint4_linear)" />
      <path d="M9 5.36365V7.26819L16.1273 5.36365H9Z" fill="url(#paint5_radial)" />
      <path d="M0.90918 17H8.52463L10.7728 13.2727L12.0592 10.8182H5.76009L0.90918 2.49817V17Z" fill="#0F9D58" />
      <path
        d="M1 17.0001H8.61545L10.9091 13.0001L12.15 10.8183H5.85091L1 2.49829V17.0001Z"
        fill="url(#paint6_linear)"
      />
      <path d="M2.27002 4.67725L7.47457 9.88088L5.85093 10.8182L2.27002 4.67725Z" fill="url(#paint7_radial)" />
      <path d="M8.62085 16.99L10.5263 9.88086L12.1499 10.8181L8.62085 16.99Z" fill="url(#paint8_radial)" />
      <path
